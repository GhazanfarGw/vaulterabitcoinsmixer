...
export default function FAQ() {
  ...
  return (
    <>
    <div className="md:py-20 py-10 overflow-hidden mx-auto justify-center items-center px-5 bg-[#121212]">
      ...
      <div className="text-[#B7BDC6] max-w-screen-lg mx-auto items-center">
        <Fragment>
          <Accordion open={open === 2} animate={customAnimation}>
            <AccordionHeader className="text-[#eaecef] border-[#ffffff] items-center border-opacity-20 text-sm md:text-base border-b text-left py-2" onClick={() => handleOpen(2)}>
          ...
          <Accordion open={open === 3} animate={customAnimation}>
            <AccordionHeader className="text-[#eaecef] border-[#ffffff] items-center border-opacity-20 text-sm md:text-base border-b text-left py-2" onClick={() => handleOpen(3)}>
          ...
          <Accordion open={open === 4} animate={customAnimation}>
            <AccordionHeader className="text-[#eaecef] border-[#ffffff] items-center border-opacity-20 text-sm md:text-base border-b text-left py-2" onClick={() => handleOpen(4)}>
          ...
          <Accordion open={open === 5} animate={customAnimation}>
            <AccordionHeader className="text-[#eaecef] border-[#ffffff] items-center border-opacity-20 text-sm md:text-base border-b text-left py-2" onClick={() => handleOpen(5)}>
          ...
          <Accordion open={open === 6} animate={customAnimation}>
            <AccordionHeader className="text-[#eaecef] border-[#ffffff] items-center border-opacity-20 text-sm md:text-base border-b text-left py-2" onClick={() => handleOpen(6)}>
          ...
          <Accordion open={open === 7} animate={customAnimation}>
            <AccordionHeader className="text-[#eaecef] border-[#ffffff] items-center border-opacity-20 text-sm md:text-base border-b text-left py-2" onClick={() => handleOpen(7)}>
          ...
          <Accordion open={open === 8} animate={customAnimation}>
            <AccordionHeader className="text-[#eaecef] border-[#ffffff] items-center border-opacity-20 text-sm md:text-base border-b text-left py-2" onClick={() => handleOpen(8)}>
          ...
          <Accordion open={open === 9} animate={customAnimation}>
            <AccordionHeader className="text-[#eaecef] border-[#ffffff] items-center border-opacity-20 text-sm md:text-base border-b text-left py-2" onClick={() => handleOpen(9)}>
          ...
          <Accordion open={open === 10} animate={customAnimation}>
            <AccordionHeader className="text-[#eaecef] border-[#ffffff] items-center border-opacity-20 text-sm md:text-base border-b text-left py-2" onClick={() => handleOpen(10)}>
          ...
          <Accordion open={open === 11} animate={customAnimation}>
            <AccordionHeader className="text-[#eaecef] border-[#ffffff] items-center border-opacity-20 text-sm md:text-base border-b text-left py-2" onClick={() => handleOpen(11)}>
          ...
          <Accordion open={open === 12} animate={customAnimation}>
            <AccordionHeader className="text-[#eaecef] border-[#ffffff] items-center border-opacity-20 text-sm md:text-base border-b text-left py-2" onClick={() => handleOpen(12)}>
